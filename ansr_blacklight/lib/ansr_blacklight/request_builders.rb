module Ansr::Blacklight
  ##
  # This module is copied directly from Blacklight 5
  # This module contains methods that mutate Ansr::Blacklight::SolrRequest
  # They transform user parameters into parameters that are sent as a request to Solr
  #
  module RequestBuilders
    ...
    def solr_search_params(user_params = params || {})
      Ansr::Blacklight::Solr::Request.new.tap do |solr_parameters|
